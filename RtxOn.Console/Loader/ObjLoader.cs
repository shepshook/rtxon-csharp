...
namespace RtxOn.Console.Loader
{
    public class ObjLoader : ILoader
    {
        ...
        public ObjLoader(string fileName)
        {
            ...
            _triangles = new();
            _textureMaps = new();
            _texture = new ImageTexture("Resources/LowPolyCars.png");
        }
        ...
        public List<Triangle> LoadMesh()
        {
            ...
            System.Console.WriteLine($"Total triangles: {_triangles.Count}");
            return _triangles;
        }
        ...
        private Vector LoadVertex(IEnumerable<string> coordinates)
        {
            ...
            return new Vector(
                ...
                -castCoordinates[1],
                castCoordinates[2])
                .Multiply(200).Sum(new Vector(650, 550, 500));
        }
        ...
        private Triangle CreateTriangle(IEnumerable<string> parameters)
        {
            ...
            if (hasTextureMaps)
            {
                ...
                return new FlatUvTriangle(vertices, textureUvs, _texture);
            }
            ...
            return new Triangle(
                ...
                _vertices[verticesIndices[1] - 1],
                _vertices[verticesIndices[2] - 1],
                _materials[_currentMaterial].DiffuseColor);
        }
